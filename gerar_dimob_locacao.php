...
<?php include "topo.php"; ?>
			    ...
			    <div class="col-md-12">
                    <div class="panel panel-inverse">
                        ...
                        <div class="panel-body">
                           <form class="form-vertical form-bordered" name="myForm" method="GET" action="teste_dimob_locacao.php">
          <div class="row">             
  ...
  <div class="form-group">
                                    <label class="col-md-2 control-label">Locador</label>
                                    <div class="col-md-4">
                                        <div class="input-group input-daterange">
                                             <select class="default-select2 form-control" name="idlocador">
                                        <option value="">Selecione</option>
                      <?php
        ...
        $query_amigo = "SELECT * FROM cliente
                        INNER JOIN cliente_tipo ON cliente_tipo.idcliente = cliente.idcliente
                        WHERE idtipo = 4 order by nome_cli Asc";
