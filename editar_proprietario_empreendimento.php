...
include "protege_professor.php";
	...
	$idproprietarios_lote   = $_GET["idproprietarios"];
...
;
	...
	$atualiza = mysqli_query($db, "UPDATE proprietarios_lote SET percentual = '$percentual', cliente_id = '$cliente_id' WHERE idproprietarios_lote = $idproprietarios_lote");
	?>
...
<body>
	...
	<?php
		...
		include "conexao.php";
		$busca = "SELECT * FROM proprietarios_lote WHERE idproprietarios_lote = $idproprietarios_lote";
		$executa = mysqli_query($db, $busca);

		 while ($row_comissao = mysqli_fetch_assoc($executa)) {
        
        $cliente_id = $row_comissao['cliente_id'];
        $percentual = $row_comissao['percentual'];
...
<li class=""><a href="ocorrencias_empreendimento.php?idlocacao=<?php echo $idlocacao ?>">Ocorrências</a></li>
<li class="active"><a href="proprietario_empreendimento.php?venda_idvenda=<?php echo $venda_idvenda ?>">Proprietários</a></li>
					</ul>
				   ...
				   <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse" data-sortable-id="form-plugins-11">
                        ...
                        <div class="panel-body panel-form">
                            <form class="form-horizontal form-bordered" action="editar_proprietario_empreendimento.php?venda_idvenda=<?php echo $venda_idvenda ?>&idproprietarios=<?php echo $idproprietarios_lote ?>" method="POST">
             ...
             $nome_cli   = $buscar_slide["nome_cli"];
                    ...
                    ?> 
                                            <option value="<?php echo $idcliente ?>"
                                            	...
                                            	<?php if($idcliente == $cliente_id){ ?> selected <?php } ?>
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                       <input type="text" class="form-control" name="percentual" id="percentual" value="<?php echo $percentual ?>"  required="" />
                                    </div>
                                </div>
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                       <input type="submit" class="btn btn-success m-r-5 m-b-5" name="atualiza" value="Alterar" />
                                    </div>
                                </div>
