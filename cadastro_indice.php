...
if(isset($_POST["descricao_indice"]))
{
    $descricao_indice = $_POST["descricao_indice"];

    include "conexao.php";
    $inserir = mysqli_query($db, "INSERT INTO indice_correcao (descricao_indice) values ('$descricao_indice')");

    ?>

    <script type="text/javascript">window.location="indices.php";</script>
...
<body>
	...
	<?php include "topo.php" ?>
		...
		<div id="content" class="content">
			...
			<!-- begin page-header -->
			<h1 class="page-header">Cadastrar Indice</h1>
			<!-- end page-header -->
			<div class="row">
                <!-- begin col-12 -->
                <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Cadastrar Novo Indice/h4>
               
                        </div>
                        <div class="panel-body">
                            <form action="cadastro_indice.php" method="POST" data-parsley-validate="true" name="form_wizard">
                                <div id="wizard">
                                    <ol>
                                        <li>
                                            Informáções Básicas 
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group block1">
                                                        <label>Descrição</label>
                                                             <input type="text" class="form-control" name="descricao_indice"  />
