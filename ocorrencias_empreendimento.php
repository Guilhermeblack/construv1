...
<li class="active"><a href="ocorrencias_empreendimento.php?venda_idvenda=<?php echo $idvenda ?>&idempreendimento=<?php echo $idempreendimento_cadastro ?>">Ocorrências</a></li>
...
<li class=""><a href="proprietario_empreendimento.php?venda_idvenda=<?php echo $venda_idvenda ?>&idempreendimento=<?php echo $idempreendimento_cadastro ?>">Proprietários</a></li>
				...
				$query = mysqli_query($db,"SELECT * FROM ocorrencia
									  WHERE quadra_id = $busca_quadra AND lote_id = $busca_lote order by idocorrencia desc") or die ("ERRO ao listar Ocorrencias"); 
