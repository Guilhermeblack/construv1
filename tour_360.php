...
$pasta  = "tour/fotos/".$idimovel."/";
$pasta2 = "tour/small/".$idimovel."/";
...
$inserir = mysqli_query ($db, "INSERT INTO tour (imovel_id, img_tour, titulo_tour) values ('$idimovel','$cod','$titulo')") or die ("Erro ao cadastrar imagem tour 360!.");
			    ...
			    <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
                        ...
                        <div class="panel-body">
                                   <form class="form-horizontal" action="tour_360.php?idimovel=<?php echo $idimovel ?>" method="POST" enctype="multipart/form-data">
...
QRcode::png("http://hrsantos.com.br/detalhes_imovel.php?idimovel=".$idimovel, "qrcode/QR_code.png");
?>
<img src="qrcode/QR_code.png">
    ...
    <div class="gallery">
        ...
        ?>
            <li id="image_li_<?php echo $row['idtour']; ?>" class="ui-sortable-handle"><a href="javascript:void(0);" style="float:none;" class="image_link"><img src="tour/fotos/<?php echo $idimovel ?>/<?php echo $row['img_tour']; ?>" alt=""></a><br><center>


            <a href="excluir_foto_tour.php?idtour=<?php echo $row['idtour']; ?>&idimovel=<?php echo $idimovel ?>&img=<?php echo $row['img_tour']; ?>"><span class="label label-danger">Remover</span></a><center></li>
        <?php } } ?>
        </ul>
    </div>
</div>
    ...
    $('.reorder_link').on('click',function(){
        ...
        $("#save_reorder").click(function( e ){
            if( !$("#save_reorder i").length ){
                ...
                $.ajax({
                    type: "POST",
                    url: "arquivos_tour/orderUpdate.php",
                    data: {ids: " " + h + ""},
                    success: function(){
