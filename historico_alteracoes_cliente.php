...
<body>
	...
	<div id="page-container" class="fade in page-sidebar-fixed page-header-fixed">
		...
		<div id="content" class="content">
			...
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Historico de Alterações do Cliente</h1>
			<!-- end page-header -->
...
<?php
        ...
        include "conexao.php"; 
 				$query_amigo = mysqli_query($db, "SELECT * FROM alteracao_cadastro_cliente where cliente_id = $idcliente"); 
        ...
        while ($buscar_amigo = mysqli_fetch_assoc($query_amigo)) {//--verifica se são amigos
          ...
          $alterado_por = nome_user($alterado_por);
             ...
             ?>
                                    ...
                                    <tr class="odd gradeX">
                                       <td><?php echo $data_alterado ?></td>
                                        <td><?php echo $alterado_por ?></td>
