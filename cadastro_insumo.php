...
if(isset($_POST["descricao"]))
{
    ...
    include "conexao.php";
    $inserir = mysqli_query($db, "INSERT INTO insumo (descricao, un) values ('$descricao','$un')");

    ?>

    <script type="text/javascript">window.location="insumos.php";</script>
...
<body>
	...
	<?php include "topo.php" ?>
		...
		<div id="content" class="content">
			...
			<!-- begin page-header -->
			<h1 class="page-header">Cadastrar Insumo</h1>
			<!-- end page-header -->
			<div class="row">
                <!-- begin col-12 -->
                <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Gerar novo Insumo</h4>
               
                        </div>
                        <div class="panel-body">
                            <form action="cadastro_insumo.php" method="POST" data-parsley-validate="true" name="form_wizard">
                                <div id="wizard">
                                    <ol>
                                        <li>
                                            Informáções Básicas 
