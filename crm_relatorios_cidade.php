...
<body>
  ...
  <div id="page-container" class="page-container fade page-sidebar-fixed page-header-fixed">
    ...
    <div id="content" class="content">
      ...
      <!-- end breadcrumb -->
      <!-- begin page-header -->
      <h1 class="page-header">Relatório - Localização</h1>
      <!-- end page-header -->
        ...
        <div class="col-md-12">
          <div class="panel panel-inverse">
            ...
            <div class="panel-body">
             <form class="form-vertical form-bordered" name="myForm" method="POST" action="contratolocacao/crm_relatorios_cidade.php">
              <div class="row">             
