...
$lotes                  = 'Lotes: '.lotes($idempreendimento);
$contratos              = 'Contratos: '.contratos($idempreendimento);
$lotes_disponiveis      = lotes_disponiveis($idempreendimento).' Lote(s)';
$lotes_reservados       = lotes_reservados($idempreendimento). ' Em negociação';

$inadi_juridico_2       = inadi_juridico_2($idempreendimento). ' Contrato(s)';
$valor_inadi_juridico_2 = valor_inadi_juridico_2($idempreendimento);
$inadi_normal           = inadi_normal($idempreendimento). ' Contratos';

$valor_inadi_juridico_2 = 'R$ ' . number_format($valor_inadi_juridico_2, 2, ',', '.');



$dados['LOTESTOTAL'] = (string) $lotes;
$dados['CONTRATOS']     = (string) $contratos;
$dados['LOTESDISPONIVEL']  = (string) $lotes_disponiveis;
$dados['LOTESRESERVADO']  = (string) $lotes_reservados;
$dados['JURIDICO']  = (string) $inadi_juridico_2;
$dados['JURIDICOTOTAL']  = (string) $valor_inadi_juridico_2;
$dados['QTDJURIDICO']  = (string) $inadi_normal;
