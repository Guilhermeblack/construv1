...
function busca_lote($venda_id){
	include "conexao.php";

	$query_amigo = "SELECT lote_idlote FROM venda where idvenda = $venda_id";
...
if(isset($_POST["motivo"])){
        ...
        $lote_id = busca_lote($venda_id);
  		...
  		$estornar = "UPDATE parcelas SET 
  					 ...
  					 WHERE venda_idvenda = $venda_id AND tipo_venda = 2";
  		$executa_estorno = mysqli_query($db, $estornar);



  		$inserir_estorno = "INSERT INTO estorno_contrato(data_hora, estornado_por, motivo, venda_id, tipo_venda) values('$hoje', '$estornado_por', '$motivo', '$venda_id','2')";
  		$executa_inserir = mysqli_query($db, $inserir_estorno);


  		$deleta_venda = mysqli_query($db, "DELETE FROM venda WHERE idvenda = $venda_id");
  		$liberar_lote = mysqli_query($db, "UPDATE lote SET status = 1 WHERE idlote = $lote_id");
?>
...
?>
		...
		<div id="content" class="content">
			...
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Estorno de Venda</h1>
			<!-- end page-header -->
			<?php 
			    ...
			    <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse" data-sortable-id="table-basic-4">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Venda</h4>
                        </div>
                        <div class="panel-body">
                        <form action="recebe_estorno_venda.php" method="POST" name="nome">
