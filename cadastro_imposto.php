...
if(isset($_POST["descricao_imposto"]))
{
    $descricao_imposto = $_POST["descricao_imposto"];

    include "conexao.php";
    $inserir = mysqli_query($db, "INSERT INTO impostos (descricao_imposto) values ('$descricao_imposto')");

    ?>

    <script type="text/javascript">window.location="impostos.php";</script>
...
<body>
	...
	<?php include "topo.php" ?>
		...
		<div id="content" class="content">
			...
			<!-- begin page-header -->
			<h1 class="page-header">Cadastrar Imposto</h1>
			<!-- end page-header -->
			<div class="row">
                <!-- begin col-12 -->
                <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Cadastrar Novo Imposto/h4>
               
                        </div>
                        <div class="panel-body">
                            <form action="cadastro_imposto.php" method="POST" data-parsley-validate="true" name="form_wizard">
                                <div id="wizard">
                                    <ol>
                                        <li>
                                            Informáções Básicas 
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group block1">
                                                        <label>Descrição</label>
                                                             <input type="text" class="form-control" name="descricao_imposto"  />
