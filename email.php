...
<table class='body'>
    <tr>
        <td class='center' align='center' valign='top'>
                                    ...
                                    <tr>
                                        <td class='wrapper'>
                                            ...
                                            <table class='six columns'>
                                                <tr>
                                                    <td>
                                                        <a href='index.html'><img src='http://immobilebusiness.com.br/vendas/s3-us-west-2.amazonaws.com/hr.png' /></a>
                                                    </td>
                                            ...
                                            <table class='six columns'>
                                                <tr>
                                                    <td class='text-right valign-middle'>
                                                        <a href='http://imobilebusiness.com.br/vendas'>Site</a>
                                                    </td>
                                                    <td class='expander'></td>
                                                </tr>
                                            </table>
                                        ...
                                        <table class='twelve columns'>
                                            <tr>
                                                <td class='last'>
                                                    <h4>Olá $nome_cli, </h4>
                                                    <p>
                                                        Separamos alguns imóveis que talvez voce tenha interesse, Confira:
                                                    </p>
                                                </td>
                                            </tr>
                                        </table>
            ...
            $cont = 1;
 $query_amigo = "SELECT * FROM email_mkt
                INNER JOIN cliente ON email_mkt.cliente_idcliente = cliente.idcliente
                INNER JOIN imovel ON email_mkt.imovel_idimovel = imovel.idimovel
            ...
            while ($buscar_amigo = mysqli_fetch_assoc($executa_query)) {//--verifica se são amigos
                ...
                $principal          = $buscar_amigo['img_principal'];
                $titulo           = $buscar_amigo['tipo'];
                $descricao          = $buscar_amigo["descricao"]; 
                                         ...
                                         $email .="<td>
                                                    <table>
                                                        <tr>
                                                            <td>
                                                                <a href='#'><img src='http://immobilebusiness.com.br/vendas/carteira/fotos/principal/$principal' width='200' height='200' /></a>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                    <h5>$titulo</h5>
                                                    ...
                                                    <table class='btn white'>
                                                        <tr>
                                                            <td>
                                                                <a href='http://immobilebusiness.com.br/vendas/detalhes.php?idimovel=$idimovel'>Ver Imóvel</a>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>";
...
// emails para quem será enviado o formulário
  ...
  $destino = $emailenviar;
  $assunto = "Imoveis | Immobile Business";

  // É necessário indicar que o formato do e-mail é html
  $headers  = 'MIME-Version: 1.0' . "\r\n";
      $headers .= 'Content-type: text/html; charset=iso-8859-1' . "\r\n";
      $headers .= 'From: '.$nome_cli.' <'.$email_cli.'>';
  //$headers .= "Bcc: $EmailPadrao\r\n";
  
  $enviaremail = mail($destino, $assunto, $email, $headers);
  if($enviaremail){
  $mgm = "E-MAIL ENVIADO COM SUCESSO! <br> O link será enviado para o e-mail fornecido no formulário";
  echo " <meta http-equiv='refresh' content='10;URL=email_mkt.php?envio=1'>";
  } else {
