...
include "conexao.php";
  				$query_amigo323 = "SELECT * FROM centrocobranca";
          $executa_query323 = mysqli_query ($db,$query_amigo323) or die ("ERRO NO SELECT");                
                
          while ($buscar_amigo323 = mysqli_fetch_assoc($executa_query323)) {//--verifica se são amigos
          $idcentrocobranca 			= $buscar_amigo323['idcentrocobranca']; 
          $descricaocentro 				= $buscar_amigo323['descricaocentro'];

          $descricaocentro 		    = remover_acentos($descricaocentro);

          echo $descricaocentro."<br>";

   
 include "conexao.php";

 $inserir = "UPDATE centrocobranca set descricaocentro ='$descricaocentro' WHERE idcentrocobranca = '$idcentrocobranca'";
 $executa_query = mysqli_query ($db, $inserir) or die("ERRO NO UPDATE");
