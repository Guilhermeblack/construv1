			   ...
			   <div class="col-md-12">
                    <div class="panel panel-inverse">
                        ...
                        <div class="panel-body">
                        	 <form class="form-vertical form-bordered" name="myForm" method="GET" action="contratolocacao/carta_cobranca.php">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="input-group input-daterange">
                                             <select class="default-select2 form-control" name="idempreendimento"  id="os" required="">
