...
$new_data_form =str_replace("/","-",$new_data_form);
		...
		$dados_gerais["data_pagamento"] = $new_data_form;
...
echo $nosso_numero_buscar;
		...
		<td class="<?php echo $bg_color;?>"><div align="right"><?php echo php_fnumber($juros_multa); $total_juros_multa+=$juros_multa;?></div></td>
