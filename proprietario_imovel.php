...
;
	...
	$inserir = mysqli_query($db, "INSERT INTO proprietarios (imovel_id, proprietario_id, percentual) values ('$idimovel','$locador_idlocador','$percentual')");
}
...
<li class="active"><a href="proprietario_imovel.php?idimovel=<?php echo $idimovel?>">Proprietários</a></li>
				   ...
				   <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse" data-sortable-id="form-plugins-11">
                        ...
                        <div class="panel-body panel-form">
                            <form class="form-horizontal form-bordered" action="proprietario_imovel.php?idimovel=<?php echo $idimovel ?>" method="POST">
            ...
            while ($buscar_slide = mysqli_fetch_assoc($query_slide)) {
             ...
             $nome_cli   = $buscar_slide["nome_cli"];
				...
				$query = mysqli_query($db,"SELECT * FROM proprietarios
									  WHERE imovel_id = $idimovel") or die ("ERRO ao listar Imóveis"); 
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td><?php echo $percentual ?>%</td>
                                         <td>
                                         	...
                                         	<a href="excluir_proprietario.php?idproprietarios=<?php echo $idproprietarios ?>&idimovel=<?php echo $idimovel ?>"><span class="btn btn-danger">Remover</span></a>



                                         	<a href="editar_proprietario_imovel.php?idproprietarios=<?php echo $idproprietarios ?>&idimovel=<?php echo $idimovel ?>"><span class="btn btn-warning">Editar</span></a></td>
