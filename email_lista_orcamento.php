                                    ...
                                    <tr>
                                        <td class='wrapper'>
                                            ...
                                            <table class='six columns'>
                                                <tr>
                                                    <td>
                                                        <a href='index.html'><img src='https://immobilebusiness.com.br/admin/assets/img/logo.png' /></a>
                                                    </td>
                                            ...
                                            <table class='six columns'>
                                                <tr>
                                                    <td class='text-right valign-middle'>
                                                        <span class='template-label'>Orçamento de Materiais</span>
                                                    </td>
                                                    <td class='expander'></td>
                                                </tr>
                                            </table>
...
// emails para quem será enviado o formulário
  ...
  //$headers .= "Bcc: $EmailPadrao\r\n";
    ...
    include "conexao.php";            
                ...
                $query_amigo_email = "SELECT * FROM fornecedor_lista
                                INNER JOIN cliente ON cliente.idcliente = fornecedor_lista.fornecedor_id
                                WHERE lista_id = $lista_id";
                $executa_query_email = mysqli_query ($db,$query_amigo_email) or die ("Erro ao listar pacotes");
                
                
            while ($buscar_amigo_email = mysqli_fetch_assoc($executa_query_email)) {//--verifica se são amigos
            $destino     = $buscar_amigo_email["email_cli"];
  ...
  if($enviaremail){
  $mgm = "E-MAIL ENVIADO COM SUCESSO! <br> O link será enviado para o e-mail fornecido no cadastro";
  echo " <meta http-equiv='refresh' content='1;URL=cadastro_lista.php?pacotes_id=".$pacotes_id."&projeto_id=".$projetos_id."&lista_id=".$lista_id."'>";
  } else {
