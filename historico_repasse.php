...
<?php include "topo_cliente.php"; ?>
		...
		<div id="content" class="content">
			...
			<!-- begin page-header -->
			<h1 class="page-header">Histórico de Repasse</h1>
			<!-- end page-header -->
...
<div class="col-md-12">
                    ...
                    <div class="panel panel-inverse">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Meus Repasses </h4>
                        </div>
  ...
  $idempreendimento = $_GET["idempreendimento"];
    ...
    $query_amigo = "SELECT * from parcelas    				
    				WHERE  cliente_id_novo = $idcliente AND fluxo = 1 AND empreendimento_id_novo = $idempreendimento";
  ...
  while ($row = mysqli_fetch_assoc($executa_query)) {
   ...
   <td>
                                         	...
                                         	<a href="area_cliente_extrato_empreendimento.php?idrepasse=<?php echo "$idparcelas"; ?>"><span class="badge badge-sucess">Ver Detalhes</span></a>
