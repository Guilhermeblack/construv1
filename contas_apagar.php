						...
						<div class="panel-body">
			                ...
			                while ($buscar_amigo = mysqli_fetch_assoc($executa_query)) {//--verifica se são amigos
			                	...
			                	<tr class="odd gradeX">
			                		...
			                		<td><?php echo utf8_encode(nome_user($cliente_id_novo)); ?></td>
