                            ...
                            <form class="form-horizontal form-bordered" action="ocorrencias_tratar.php?idocorrencia=<?php echo $idocorrencia ?>" method="POST" enctype="multipart/form-data">
                               ...
                               <?php    
								  ...
								  $descricao = $dados_titulo_descriçao['descricao'];
									$status_ocorr = $dados_titulo_descriçao['status_ocorrencia'];	
                               ...
                               ?>
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-md-9">
									<?php if($status_ocorr == 4){
										?> <textarea class="form-control" name="descricao_tratar" disabled=""></textarea>
									<?php
										}else{
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="col-md-9">
									<?php if($status_ocorr == 4){	?>
										<select name="status_ocorrencia" class="form-control" disabled=''>
									<?php }else{ ?>
                                   ...
                                   <div class="form-group">
                                    ...
                                    <div class="col-md-9">
									<?php if($status_ocorr == 4){	?>
									 <input type="file" name="img[]" multiple="" disabled=''>
									<?php }else{ ?>
