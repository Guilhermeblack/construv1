	...
	<div id="page-container" class="fade in page-sidebar-fixed page-header-fixed">
		...
		<div id="content" class="content">
			<!-- begin breadcrumb -->
				...
				<li><a href="contacorrente.php"><span class="label label-primary" style="font-size:100% !important">NOVO CONTA</span></a></li>
				<?php } ?>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
...
<?php
            ...
            while ($buscar_amigo = mysqli_fetch_assoc($executa_query)) {//--verifica se são amigos
             ...
             ?>
                                    ...
                                    <tr class="odd gradeX">
                                       <td><?php echo $banco_cedente ?></td>
                                       <td><?php echo "$agencia "."/"." $dig_agencia" ?></td>
                                       <td><?php echo "$conta "."/"." $dig_conta" ?></td>
                                       <td><?php echo $carteira ?></td>
                                       <td><?php echo $nome_empresa ?></td>
                                       <td>   
                                       <a href="alterar_contacorrente.php?idcontacorrente=<?php echo $idcontacorrente ?>">  <span class="label label-success"> Ver /Alterar</span></a>	</td>
                                    </tr>
                                     <?php } ?>
                                </tbody>
                            </table>
