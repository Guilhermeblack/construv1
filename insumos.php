	...
	<div id="page-container" class="fade in page-sidebar-fixed page-header-fixed">
		...
		<div id="content" class="content">
			<!-- begin breadcrumb -->
				...
				<li><a href="cadastro_insumo.php"><span class="label label-primary" style="font-size:100% !important">NOVO INSUMO</span></a></li>
				<?php } ?>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
...
<?php
 ...
 <a href="excluir_insumo.php?id=<?php echo $id ?>">  <span class="label label-danger">Excluir</span></a>
