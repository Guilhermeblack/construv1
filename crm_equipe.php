...
<body>
  ...
  <div id="page-container" class="fade in page-sidebar-fixed page-header-fixed">
    ...
    <div id="content" class="content">
      ...
      <h1 class="page-header">Cadastro de Equipes</h1>
      <!-- end page-header -->
...
<form class="form-vertical form-bordered" name="myForm" method="POST" action="crm_roletaimovel.php">
            <div class="panel-body">
              <table id="data-table" class="table table-striped table-bordered">
                ...
                <tbody>
                  ...
                  $query_amigo = "SELECT * FROM cliente AS C INNER JOIN cliente_tipo AS CT ON C.idcliente = CT.idcliente WHERE idtipo = 11 ORDER BY C.idcliente";
            ...
            while ($buscar_amigo = mysqli_fetch_assoc($executa_query)) {//--verifica se são amigos
              ...
              $id                 = $buscar_amigo['idcliente'];
              $nome               = $buscar_amigo["nome_cli"];
              
              $query_amigo2 = "SELECT * FROM crm_equipe WHERE crm_equipe = $id";
...
while ($buscar_amigo2 = mysqli_fetch_assoc($executa_query2)) {
  $imob = $buscar_amigo2["crm_equipe"];
              ...
              <tr class="odd gradeX">
                ...
                <td><input type="checkbox" name="ver[]" <?php if ($id == $imob) {
                      echo "checked"; 
