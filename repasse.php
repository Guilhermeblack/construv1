...
document.nome.action = "receber_parcelas_repasse.php";
...
document.nome.action = "estornar_repasse.php";
document.nome.submit();
...
<?php include "topo.php"; ?>
       ...
       <?php if (in_array('12', $idrota)) { ?>
        <li><a href="#" onclick="receber()"><span class="label label-success">LANÇAR REPASSE</span></a></li>
        <?php } ?> 


        <?php if (in_array('12', $idrota)) { ?>
        <li><a href="#" onclick="estornar()"><span class="label label-danger">ESTORNAR REPASSE</span></a></li>
        <?php } ?>
			    ...
			    <div class="col-md-12">
                    <div class="panel panel-inverse">
                        ...
                        <div class="panel-body">
                        	 <form class="form-horizontal form-bordered" name="myForm" method="GET" action="repasse.php">
                                 ...
                                 <div class="form-group">
                                    <label class="col-md-4 control-label">Tipo Periodo</label>
                                    <div class="col-md-8">
...
<?php 
      ...
      <?php }  ?>
                                   ...
                                   <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <div class="input-group input-daterange">
                                            <input type="radio" name="situacao" value="0">Não Lançado<br>
                                            <input type="radio" name="situacao" value="1">Lançado<br>
                                            <input type="radio" name="situacao" value="2">Todos<br>
                                        ...
                                        <div class="form-group">
                                    <label class="col-md-4 control-label">Código Repasse</label>
                                    <div class="col-md-8">
                                        <div class="input-group input-daterange">
                                            <input type="text" name="cod_repasse" class="form-control">
...
<?php 
      ...
      if($situacao == 1){
        $situacao_and = " AND repasse_feito = '1' ";
      }elseif ($situacao == 0) {
        $situacao_and = " AND repasse_feito = '0' ";
      }else{
        $situacao_and = '';
      }
...
//////
       if($cod_repasse != ''){
        $situacao_and = '';
        $situacao_and .= " AND codigo_repasse =".$cod_repasse;
      }

?>
            
            <input type="hidden" name="cod_repasse" value="<?php echo $cod_repasse ?>">
...
<?php 
          ...
          $fim     = converterdata($fim);
				...
				include "conexao.php";
				$query = "SELECT idparcelas, tipo_venda, venda_idvenda, valor_recebido, valor_parcelas, data_recebimento, descricao,situacao,forma_pagamento,repasse_feito,codigo_repasse, tipo_venda, STR_TO_DATE(data_vencimento_parcela, '%d-%m-%Y') as venc 
                                  FROM parcelas 
                                  WHERE idparcelas > 0 AND fluxo = 0 $situacao_and order by venc Asc"; 
        ...
        $executar_parcelas = mysqli_query($db, $query);
                while ($buscar_amigo = mysqli_fetch_assoc($executar_parcelas)) {//--verifica se são amigos
                  ...
                  {
                    $texto_situacao = '<span class="label label-danger">EM ABERTO</span>';
                  }else{
                  ...
                  if($repasse_feito == 0)
                  {
                    $texto_repasse = '<span class="label label-danger">NÃO LANÇADO</span>';
                  }else{
                    $texto_repasse = '<span class="label label-success">LANÇADO</span>';
                  ...
                  if($fluxo == 4)
                  {
                    $texto_fluxo = '<span class="label label-danger">Despesa Proprietário</span>';
                  }else{
                    $texto_fluxo = '<span class="label label-success">Receita Empreeendimento</span>';
		     ...
		     ?>
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td><?php echo $texto_situacao ?></td>
                                          <td><?php echo $texto_repasse ?></td>
                                            <td><?php echo $texto_fluxo ?></td>
                                        <td><?php echo $codigo_repasse ?></td>
