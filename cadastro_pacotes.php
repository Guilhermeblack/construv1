...
{
    $nome       = $_POST["nome"];
    $projeto_id = $_GET["idprojeto"];

    include "conexao.php";
    $inserir = mysqli_query($db, "INSERT INTO pacotes (nome) values ('$nome')");
    $pacotes_id = mysqli_insert_id($db);

    $inserir_pacote_projeto = mysqli_query($db, "INSERT INTO projeto_etapa (projeto_id, pacotes_id) values ('$projeto_id','$pacotes_id')");

    ?>

    <script type="text/javascript">window.location="projeto_etapa.php?idprojeto=<?php echo $projeto_id ?>";</script>
	...
	<?php include "topo.php";
     ...
     ?>
		...
		<div id="content" class="content">
			...
			<!-- begin page-header -->
			<h1 class="page-header">Cadastrar Etapas de Projeto</h1>
			<!-- end page-header -->
			<div class="row">
                <!-- begin col-12 -->
                <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Gerar nova Etapa</h4>
               
                        </div>
                        <div class="panel-body">
                            <form action="cadastro_pacotes.php?idprojeto=<?php echo $projeto_id ?>" method="POST" data-parsley-validate="true" name="form_wizard">
                                <div id="wizard">
                                    <ol>
                                        <li>
                                            Informáções Básicas 
