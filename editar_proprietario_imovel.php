...
;
	...
	$altera_proprietario = "UPDATE proprietarios SET proprietario_id = '$locador_idlocador', percentual = '$percentual' WHERE idproprietarios = $idproprietario";
				   ...
				   <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse" data-sortable-id="form-plugins-11">
                        ...
                        <div class="panel-body panel-form">
                            <form class="form-horizontal form-bordered" action="editar_proprietario_imovel.php?idimovel=<?php echo $idimovel ?>&idproprietarios=<?php echo $idproprietario ?>" method="POST">
