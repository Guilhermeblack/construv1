...
if(isset($_POST["descricao_modelo"])){
	...
	$inserir = "INSERT INTO modelo_contrato (conteudo, descricao_modelo, empreendimento_id, tipo_doc) values('$conteudo', '$descricao_modelo', '$empreendimento_id', '$tipo_doc')";

	//echo $inserir; die();
	$executa_inserir = mysqli_query($db, $inserir) or die(mysql_error());
