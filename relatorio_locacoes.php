...
<ol class="breadcrumb pull-right">
				<?php if (in_array('21', $idrota)) { ?>
				<li><a href="cadastro_locacao.php"><span class="label label-primary" style="font-size:100% !important">NOVO CONTRATO DE LOCAÇÃO</span></a></li>
				<?php } ?>
				
			</ol>

			<!-- begin page-header -->
			<h1 class="page-header">Relatório de locações</h1>
			<!-- end page-header -->
 ...
 $query_amigo = "SELECT * FROM locacao
                ...
                $status_contrato= $buscar_amigo["status_contrato"];
                ...
                if($status_contrato == '1'){
                	$status_contrato = '<span class="label label-success">Ativo</span>';
                }elseif($status_contrato == '2'){
                	$status_contrato = '<span class="label label-warning">Suspenso</span>';
                }else{
                   	$status_contrato = '<span class="label label-danger">Encerrado</span>';
	              }
             ...
             ?>
                            <tr class="odd gradeX">
                                ...
                                <td><?php echo "$endereco".", "."$numero". " Cep:".$cep ?></td>
                                <td><?php echo $ref ?></td>
 								<td><?php echo $nome_cli ?></td>
                                <td><?php echo $telefone1_cli ?></td>
                                <td><?php echo $data_cadastro ?></td>
                                <td><?php echo $status_contrato ?></td>
                                <td> <a href="ver_contrato.php?idlocacao=<?php echo $idlocacao ?>"><button type="button" class="btn btn-success"><i class="fa fa-edit"></i>Abrir</button></a></td>
                     		</tr>
