...
if(isset($_POST["descricao"]))
{
    ...
    $taxa      = $_POST["taxa"];
    // $qnt_parcelas = $_POST['qnt_parcela'];
    // $prazo    =  $_POST['prazo_pagamento'];
   

 include "conexao.php";


 $inserir_contrato = ("INSERT INTO `forma_pagamento`(`descricao`, `taxa`, `qnt_vezes`, `prazo`) VALUES ('$descricao','$taxa', '', '')");

$executar = mysqli_query ($db, $inserir_contrato);
?>

<script type="text/javascript">window.location="forma_pagamento.php";</script>
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse">
                        ...
                        <div class="panel-body">
                            <form action="cadastro_forma_pagamento.php" method="POST" data-parsley-validate="true" name="form_wizard">
                                <div id="wizard">
                                    <ol>
                                        <li>
                                            Identificação
                                            ...
                                            <div class="row">
                                                ...
                                                <!-- <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" class="form-control" name="qnt_parcela" required=""  />
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label>Prazo de Pagamento</label>
                                                        <input type="number" class="form-control" name="prazo_pagamento" placeholder="Prazo de Pagamento em Dias" />
                                                    </div>
                                                </div> -->
                                            </div>
                                        </fieldset>
