...
<!-- saved from url=(0087)http://app.valuegaia.com.br/admin/modules/fichas/ficha-captacao-imovel-print.aspx?id=25 -->
    ...
    <table id="TABLE1" onclick="return TABLE1_onclick()">
        ...
        <tr>
            <td colspan="6" align="center">
                <h1>
                    Ficha de Captação de Imóvel (Sobrado) - Data:____/____/____</h1>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td style="height: 21px">
                (<span class="white">__</span>)Res&nbsp;(<span class="white">__</span>)Com&nbsp;(<span class="white">__</span>)Tem&nbsp;
