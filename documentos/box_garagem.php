...
<!-- saved from url=(0087)http://app.valuegaia.com.br/admin/modules/fichas/ficha-captacao-imovel-print.aspx?id=42 -->
    ...
    <table id="TABLE1" onclick="return TABLE1_onclick()">
        ...
        <tr>
            <td colspan="6" align="center">
                <h1>
                    Ficha de Captação de Imóvel (Box/Garagem) - Data:____/____/____</h1>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="6">
                <ul class="detalhes"><li><strong>Infraestrutura:</strong>&nbsp;&nbsp;(&nbsp;&nbsp;)Elevador&nbsp;&nbsp;(&nbsp;&nbsp;)Nº de andares&nbsp;&nbsp;(&nbsp;&nbsp;)Nº do andar&nbsp;&nbsp;(&nbsp;&nbsp;)Portão eletrônico&nbsp;&nbsp;(&nbsp;&nbsp;)Altura do pé direito&nbsp;&nbsp;(&nbsp;&nbsp;)Vagas cobertas&nbsp;&nbsp;(&nbsp;&nbsp;)Vagas descobertas&nbsp;&nbsp;(&nbsp;&nbsp;)Vagas&nbsp;&nbsp; Tipo de vaga: <u>Não informado</u>&nbsp;&nbsp; Característica da vaga: <u>Não informado</u></li></ul>
            </td>
        </tr>
        <tr>
            <td style="height: 21px">
