...
<!-- saved from url=(0087)http://app.valuegaia.com.br/admin/modules/fichas/ficha-captacao-imovel-print.aspx?id=20 -->
    ...
    <table id="TABLE1" onclick="return TABLE1_onclick()">
        ...
        <tr>
            <td colspan="6" align="center">
                <h1>
                    Ficha de Captação de Imóvel (Terreno) - Data:____/____/____</h1>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td style="height: 21px">
                (<span class="white">__</span>)Res&nbsp;(<span class="white">__</span>)Com&nbsp;(<span class="white">__</span>)Ind&nbsp;(<span class="white">__</span>)Cor&nbsp;
        ...
        <tr>
            <td colspan="6">
                <ul class="detalhes"><li><strong>Infraestrutura:</strong>&nbsp;&nbsp;(&nbsp;&nbsp;)Água&nbsp;&nbsp;(&nbsp;&nbsp;)Esgoto&nbsp;&nbsp;(&nbsp;&nbsp;)Pavimentação&nbsp;&nbsp;(&nbsp;&nbsp;)Tipo de pavimentação&nbsp;&nbsp;(&nbsp;&nbsp;)Energia&nbsp;&nbsp;(&nbsp;&nbsp;)TV a cabo&nbsp;&nbsp;(&nbsp;&nbsp;)Imóvel no litoral&nbsp;&nbsp;(&nbsp;&nbsp;)Vista para o mar&nbsp;&nbsp;(&nbsp;&nbsp;)Em costeira/Pé na areia&nbsp;&nbsp;(&nbsp;&nbsp;)Beira Mar&nbsp;&nbsp;(&nbsp;&nbsp;)Metros da praia</li></ul>
            </td>
        </tr>
        <tr>
            <td style="height: 21px">
