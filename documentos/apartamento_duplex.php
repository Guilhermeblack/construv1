...
<!-- saved from url=(0087)http://app.valuegaia.com.br/admin/modules/fichas/ficha-captacao-imovel-print.aspx?id=35 -->
...
<body style="background-color: #ffffff">
    <table id="TABLE1" onclick="return TABLE1_onclick()">
        ...
        <tbody>
            <?php include "../dados_corretor.php"; ?>
        ...
        <tr>
            <td colspan="6" align="center">
                <h1>
                    Ficha de Captação de Imóvel (Apartamento Duplex) - Data:____/____/____</h1>
            </td>
        </tr>
        <tr>
