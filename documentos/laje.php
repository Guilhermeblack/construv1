...
<!-- saved from url=(0087)http://app.valuegaia.com.br/admin/modules/fichas/ficha-captacao-imovel-print.aspx?id=29 -->
    ...
    <table id="TABLE1" onclick="return TABLE1_onclick()">
        ...
        <tr>
            <td colspan="6" align="center">
                <h1>
                    Ficha de Captação de Imóvel (Laje) - Data:____/____/____</h1>
            </td>
        </tr>
        <tr>
