...
<tr class="odd gradeX">
                                          ...
                                          <td colspan="3"><span class="label label-primary" style="font-size:100% !important"><?php echo $nome ?></span></td>
...
<?php
            ...
            $descricao           	= $buscar_amigo['descricao'];
             ...
             ?>
                                    ...
                                    <tr class="odd gradeX">
                                    	<th><input type="checkbox" name="insumos[]" value="<?php echo $insumo_id ?>"> </th>
