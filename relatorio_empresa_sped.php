	...
	<div id="page-container" class="fade in page-sidebar-fixed page-header-fixed">
		...
		<div id="content" class="content">
			...
			if(isset($_GET['idempresa']) && !empty($_GET['idempresa'])){
				...
				<h1 class="page-header">Configurações Sped da Empresa&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;<font style="color: red">   (Ja existe cadastro para esta empresa !!! )</font></h1>
				...
				<h1 class="page-header">Configurações Sped da Empresa</h1>
            ...
            while ($buscar_amigo = mysqli_fetch_assoc($executa_query)) {//--verifica se são amigos
            	...
            	<tr class="odd gradeX">
            		...
            		<td>   
            			<a href="alterar_sped_empresa.php?idempresa=<?php echo $idempresa ?>&status=configurar">  <span class="label label-success"> Ver /Alterar</span></a>	</td>
            		</tr>
            		<?php } ?>
            	</tbody>
            </table>
