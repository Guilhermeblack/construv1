			...
			<div class="row">
			    ...
			    <div class="col-md-2">
                    ...
                    <p>
                     ...
                     <div><b class="text-inverse">Forma da Renegociação</b></div>
                    <p>
                      @total_contrato, @total_arenegociar, 
                      @parcela_de, @parcela_ate, @total_de_parcelas
                      @data_de, @data_ate, 
                      @valor_da_parcela_renegociacao,
			    ...
			    <div class="col-md-10">
                    <div class="panel panel-inverse m-b-0">
                        ...
                        <div class="panel-body p-0">
                                <textarea class="summernote" name="conteudo"><?php echo $conteudo ?></textarea>
