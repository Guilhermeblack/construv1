...
include "func_painel_inadimplencia.php";?>
		...
		<div id="content" class="content">
			...
			<!-- begin page-header -->
			<h1 class="page-header">Comissão </h1>
			<!-- end page-header -->
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse" data-sortable-id="form-plugins-1">
                        ...
                        <div class="panel-body panel-form">
                            <form class="form-horizontal form-bordered" name="myForm" method="GET" action="contratolocacao/comissao.php">
                                ...
                                <div class="form-group" id="periodo">
                                    ...
                                    <label class="col-md-4 control-label">Imobiliaria:</label>
                                    <div class="col-md-8">
  ...
  <div class="modal fade" id="modal-dialog">
              ...
              <form class="form-group" id="ajax_form" action="" method="POST">
                               <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                       ...
                                       <input type="hidden" name="tipo_venda"  id="tipo_venda"  value="">  
                    ...
                    <div class="modal-footer">
                      ...
                      <input type="submit"   class="btn btn-sm btn-success" value="Gravar Informações"/>
                        </form>
                    </div>
                  </div>
                </div>
