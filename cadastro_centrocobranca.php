...
include "conexao.php";
  ...
  $inserir_banco = mysqli_query($db,"INSERT INTO centrocobranca (ref, descricaocentro) values ('$ref', '$descricaocentro')");
...
<body>
	...
	<?php include "topo.php" ?>
		...
		<div id="content" class="content">
			...
			<!-- begin page-header -->
			<h1 class="page-header">Cadastro Centro de Receita</h1>
			<!-- end page-header -->
			<div class="row">
                <!-- begin col-12 -->
                <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Cadastro Centro de Receita</h4>
               
                        </div>
                        <div class="panel-body">
                            <form action="cadastro_centrocobranca.php" method="POST" data-parsley-validate="true" name="form_wizard">
                                <div id="wizard">
                                    <ol>
                               ...
                               <input type="text" class="form-control"   name="ref" />
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                          <input type="text" class="form-control" name="descricaocentro" />   
                                                        </div>
                                                    </div>
                                                </div>
