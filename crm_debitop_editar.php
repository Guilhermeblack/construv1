...
<body>
	...
	<div id="page-container" class="fade page-header-fixed page-sidebar-fixed">
		...
		<div id="content" class="content">
					...
					<div class="panel panel-inverse m-b-0">
						...
						<div class="panel-body">
							<div class="form-group">
								...
								$idpremio = $_GET["edit"];
								?>
								<form class="dropzone" id="addImages" method="POST" enctype="multipart/form-data" name="formodal" action="crm_salvapremio.php?edit=<?php echo $idpremio ?>">
									<div class="row">

										<?php 

									$query = "SELECT * FROM crm_premio WHERE crm_idpremio = $idpremio";
									$exec_query = mysqli_query($db, $query);
									while ($busca_query = mysqli_fetch_assoc($exec_query)){
										$idp = $busca_query["crm_idpremio"];
										$descp = utf8_encode($busca_query["crm_descricaopremio"]);
										$vlrp = $busca_query["crm_vlrpremio"];
										$fotop = $busca_query["crm_fotopremio"];
										$interessep = $busca_query["crm_empid"];
										$ativop = $busca_query["crm_statuspremio"];
										$nomep = utf8_encode($busca_query["crm_titulopremio"]);
										$estrelasp = $busca_query["crm_estrelaspremio"];
										...
										<div class="col-md-4">
											<div class="form-group">
												...
												<input type="text" placeholder="Nome do Prêmio" name="npremio" class="form-control" required="" value="<?php echo $nomep ?>" /> 
										...
										<div class="col-md-4">
											<div class="form-group">
												...
												<input type="number" min="0" max="5" id="data" placeholder="0" name="stars" class="form-control" required="" value="<?php echo $estrelasp ?>" />
										...
										<div class="col-md-4">	
											<div class="form-group">
												<label>Valor:</label>
												<input type="number" min="0" id="vlrpts" name="valorpts" placeholder="pt$" class="form-control" required="" value="<?php echo $vlrp ?>"/>
											</div>
										</div>
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<textarea placeholder="Descrição do Prêmio." class="form-control" name="descricao" required=""><?php echo $descp ?></textarea>
											</div>
										</div> 
										...
										<div class="col-md-6">
											...
											<select class="form-control" name="interessef" id="interesse" >
												...
												FROM empreendimento
												INNER JOIN empreendimento_cadastro ON empreendimento_cadastro_id = idempreendimento_cadastro order by descricao_empreendimento desc";
            ...
            while ($buscar_amigoc = mysqli_fetch_assoc($executa_queryc)) {//--verifica se são amigos
            	...
            	?>
            	<option value="<?php echo $id?>" <?php if ($id == $interessep): ?>
            		selected
            	<?php endif ?> ><?php echo $descricao ?></option>
            <?php }  ?>
        </select>
    ...
    <div class="col-md-4">
    	<input type="checkbox" name="ativof" value="1" <?php if ($ativop == 1) {
    		echo "checked";
    	} ?> > Ativo?
