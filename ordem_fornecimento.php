...
<body>
	...
	<!-- end #page-loader -->
	<?php 		$idlista_cotacao = $_GET["lista_cotacao"]; ?>
	...
	<div id="page-container" class="fade in page-sidebar-fixed page-header-fixed">
		...
		<div id="content" class="content">
			...
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Ordem de Fornecimento</h1>
			<!-- end page-header -->
             ...
             ?>
                                    ...
                                    <tr class="odd gradeX">
                                        <td><?php echo $nome_cli ?></td>                                       
                                          ...
                                          <td><a href="contratolocacao/ordem_fornecimento.php?lista_cotacao=<?php echo $idlista_cotacao ?>&idcliente=<?php echo $idlocador ?>"><span class="label label-primary"> IMPRIMIR O.F. </span></a></td>
