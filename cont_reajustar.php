...
document.nome.submit();
	...
	<div id="page-container" class="fade in page-sidebar-fixed page-header-fixed">
		...
		<div id="content" class="content">
			...
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Relatorio de Contratos à Reajustar </h1>
			<!-- end page-header -->
			   ...
			   <div class="col-md-12">
                    <div class="panel panel-inverse">
                        ...
                        <div class="panel-body">
                        	 <form class="form-vertical form-bordered" name="myForm" method="GET" action="contratolocacao/reajustar.php">
...
<div class="row">
         ...
         <div class="form-group" id="teste">
                                    <label class="col-md-2 control-label">Selecione o empreendimento</label>
                                    <div class="col-md-4">
