...
include "conexao.php";
 ...
 $excluir_comando="UPDATE empreendimento SET 
      img_do_mapa='$cod'
...
<body>
	...
	<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
		...
		<div id="content" class="content">
			...
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Adicionar Mapa </h1>
			<!-- end page-header -->
			...
			<div class="row">
			    ...
			    <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" action="mapa_empreendimentos.php?idempreendimento=<?php echo $idempreendimento ?>" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <button type="submit" class="btn btn-sm btn-success">Adicionar Mapa</button>
                                    </div>
                                </div>
                            </form>
                        </div>
                ...
                $query_slide = mysqli_query($db,"SELECT idempreendimento, img_do_mapa FROM empreendimento
                                    WHERE idempreendimento = $idempreendimento
                    order by idempreendimento limit 1") or die ("Erro ao listar fotos, tente mais tarde"); 


            while ($buscar_slide = mysqli_fetch_assoc($query_slide)) {//--While categoria
           
             $idempreendimento         = $buscar_slide["idempreendimento"];
             $img_do_mapa             = $buscar_slide["img_do_mapa"];
          

                    ?> 
                                
                                    <tr>
                                        <td><img src="../img/<?php echo $idempreendimento ?>/<?php echo $img_do_mapa ?>" width="150" height="150" /></td>
