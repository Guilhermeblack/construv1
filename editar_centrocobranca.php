...
$idcentrocobranca   = $_GET["idcentrocobranca"];
$ref                = $_POST["ref"];
$descricaocentro    = $_POST["descricaocentro"];
...
$altera = "UPDATE centrocobranca SET ref = '$ref', descricaocentro = '$descricaocentro' WHERE idcentrocobranca = $idcentrocobranca";

$executa_altera = mysqli_query($db, $altera);


  ?>

<script type="text/javascript">window.location='centro_cobranca.php';</script>
...
<?php 
$centrocobranca_id = $_GET["idcentrocobranca"];
 include "conexao.php";
                $query_slide = mysqli_query($db,"SELECT * FROM centrocobranca
                                                 WHERE idcentrocobranca = $centrocobranca_id"); 


            while ($buscar_slide = mysqli_fetch_assoc($query_slide)) {//--While categoria
           
             $ref                  = $buscar_slide["ref"];
             $descricaocentro      = $buscar_slide["descricaocentro"];
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Editar Centro de Receita</h4>
               
                        </div>
                        <div class="panel-body">
                            <form action="editar_centrocobranca.php?idcentrocobranca=<?php echo $centrocobranca_id ?>" method="POST" data-parsley-validate="true" name="form_wizard">
                                <div id="wizard">
                                    <ol>
                                        
                                         <li>
Informações                                            <small></small>
                                        </li>
                               ...
                               <input type="text" class="form-control" name="ref" value="<?php echo $ref ?>" />
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                          <input type="text" class="form-control" name="descricaocentro" value="<?php echo $descricaocentro ?>" />   
                                                        </div>
                                                    </div>
                                                </div>
