...
$dados['rua'] = remover_acentos($dados['rua']);
$dados['cidade'] = remover_acentos($dados['cidade']);
$dados['bairro']  = remover_acentos($dados['bairro']);
$endereco = $dados['rua'] . " " . $dados['bairro'] . " " . $dados['cidade'] . " " . $dados['estado'];


$endereco = str_replace(" ","%20", $endereco);

$geocode = file_get_contents('https://maps.google.com/maps/api/geocode/json?address='.$endereco.'&sensor=false&key=AIzaSyDdVRY-Suj8VPsCebuqFss-bKooLiRjkAs');
