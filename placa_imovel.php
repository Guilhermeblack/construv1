...
;
	$data_placa 	= date('d-m-Y');
 
	include "conexao.php";

	$inserir = mysqli_query($db, "INSERT INTO placa_imovel (data_placa, imovel_idimovel) values ('$data_placa','$idimovel')");
}
...
<li class="active"><a href="placa_imovel.php?idimovel=<?php echo $idimovel?>">Placa</a></li>
<li class=""><a href="proprietario_imovel.php?idimovel=<?php echo $idimovel?>">Proprietários</a></li>
				   ...
				   <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse" data-sortable-id="form-plugins-11">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Placa Imóvel</h4>
                        </div>
                        <div class="panel-body panel-form">
                            <form class="form-horizontal form-bordered" action="placa_imovel.php?idimovel=<?php echo $idimovel ?>" method="POST">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                       <input type="submit" class="btn btn-success m-r-5 m-b-5" name="atualiza" value="Atualizar Placa" />
                                    </div>
                                </div>
                    ...
                    <div class="panel panel-inverse">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Ultima Trocas de Placa</h4>
                        </div>
				...
				include "conexao.php";
				$query = mysqli_query($db,"SELECT * FROM placa_imovel
									  WHERE imovel_idimovel = $idimovel order by idplaca_imovel desc") or die ("ERRO ao listar placas"); 


		    while ($buscar = mysqli_fetch_assoc($query)) {//--While categoria
		   
		     $data_placa 				= $buscar["data_placa"];
