...
if(isset($_POST["valor_parcelas"]))
{
    ...
    $idparcelas              = $_GET["idparcela"];   
    $valor_parcelas          = $_POST["valor_parcelas"];   
    $data_vencimento         = $_POST["data_vencimento_parcela"];
    $fluxo                   = $_POST["fluxo"];
    ...
    data_vencimento_parcela       ='$data_vencimento'
    WHERE idparcelas = $idparcelas");

    $executa_alterar = mysqli_query($db, $inserir);   
  ...
  else
  {
	...
	<?php include "topo.php" ?>
		...
		<div id="content" class="content">
            ...
            $executa_query = mysqli_query ($db,$query_amigo) or die ("Erro ao listar parcela");
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Editar Parcela</h4>
                            
                        </div>
                        <div class="panel-body">
                            <form action="editar_parcela_conta_pagar.php?idparcela=<?php echo $idparcelas ?>" method="POST" data-parsley-validate="true" name="form_wizard">
                                <div id="wizard">
                                    <ol>
                                        <li>
                                            Informações
                                    ...
                                    <div class="wizard-step-1">
                                        ...
                                        <input type="text" class="form-control" name="valor_parcelas" value="<?php echo 'R$' . number_format($valor_parcelas, 2, ',', '.'); ?>" required="" id="valor_aluguel2" />
                                                ...
                                                <!-- end col-6 -->
                                                 <div class="col-md-4">
                                                   ...
                                                   <input type="date" class="form-control" name="data_vencimento_parcela" value="<?php echo $data_vencimento_parcela ?>"  required=""   />
                                                    </div>
                                                </div>
                                            </div>
                                         ...
                                         <p><input type="submit" class="btn btn-success btn-lg" role="button" value="Salvar" /></p>
                                    </div>
                                    <!-- end wizard step-1 -->
