...
include "func_painel_inadimplencia.php";?>
		...
		<div id="content" class="content">
			...
			<!-- begin page-header -->
			<h1 class="page-header">Inadimplência - Locação </h1>
			<!-- end page-header -->
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse" data-sortable-id="form-plugins-1">
                        ...
                        <div class="panel-body panel-form">
                            <form class="form-horizontal form-bordered" name="myForm" method="GET" action="contratolocacao/inadimplentes-locacao.php">
                       
                                 <div class="form-group">
                                    <label class="col-md-4 control-label">Situação</label>
                                    <div class="col-md-4">
                                        <div class="input-group ">
                                            <input type="radio" name="situacao" value="1" required="" onclick="mostra_periodo(1)">90 dias<br>
                                            <input type="radio" name="situacao" value="2" required="" onclick="mostra_periodo(2)">60 dias<br>
                                            <input type="radio" name="situacao" value="3" required="" onclick="mostra_periodo(3)">30 dias<br>
                                            <input type="radio" name="situacao" value="4" required="" onclick="mostra_periodo(4)">Definir Periodo
                                           
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group" id="periodo" style="display: none">
