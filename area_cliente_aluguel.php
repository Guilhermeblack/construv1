...
<?php include "topo_cliente.php"; ?>
		...
		<div id="content" class="content">
			...
			<!-- begin page-header -->
			<h1 class="page-header">Minhas locações</h1>
			<!-- end page-header -->
    ...
    <?php
 		...
 		$query_amigo = "SELECT * FROM locacao
                 		...
                 		WHERE locacao.cliente_idcliente = $idcliente";

        $executa_query = mysqli_query ($db,$query_amigo) or die ("Erro ao listar imovel");
        ...
        while ($buscar_amigo = mysqli_fetch_assoc($executa_query)) {
             ...
             ?>
                                    ...
                                    <td><?php echo "$tipo " ?><?php echo " $endereco ".","." $numero "."$bairro" ?></td>
                                     <td><?php echo $ref ?></td>
                                         ...
                                         <td> <a href="parcelas_cliente.php?idvenda=<?php echo $idlocacao ?>"><button type="button" class="btn btn-success"><i class="fa fa-edit"></i>Pagamentos</button></a></td>
