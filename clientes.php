   ...
   ?>
          ...
          include "conexao.php";
              ...
              if (in_array('49', $idrota)) {       //  Administrador Lista todos os clientes
               $query_amigo = "SELECT cliente.idcliente, cliente.nome_cli, cliente.cpf_cli, cliente.telefone1_cli              FROM cliente
              ...
              $query_amigo = "SELECT cliente.idcliente, cliente.nome_cli, cliente.cpf_cli, cliente.telefone1_cli, vinculo.idcorretor
              FROM cliente
            ...
            while ($buscar_amigo = mysqli_fetch_assoc($executa_query)) {//--verifica se são amigos
              ...
              ?>
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td><?php 
               $grupo_cliente = grupo_cliente($categoria_cliente);

               echo $grupo_cliente['descricao'] ?>
